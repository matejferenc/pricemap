...
import com.averagemap.core.coordinates.model.border.JacksonBorderConverter;
...
public class JacksonBorderConverterTest {
    ...
    public void testConvertBorder() throws IOException {
        ...
        Border border = new JacksonBorderConverter(zoomSpecificBorderFactory).convert((MultiPolygon) geometry);
        String a = "a";
    }
}
